...
def get_all_expenses():
    ...
    try:
        ...
        # Returns a list of sqlite3.Row objects (behaving like dicts/tuples)
...
if __name__ == '__main__':
    ...
    # Needs db to be created first, which it should be from the earlier test
    ...
    for row in all_exp:
        # Thanks to row_factory in db.py, we can access by key
    ...
    print("\n4. Testing Deletion:")
    if all_exp:
        first_id = all_exp[0]['id'] # Delete the top one from the list
